...
interface WorldEgoShardProjectileRuntimeDeps {
  getPlayer: () => Player;
...
export class WorldEgoShardProjectileRuntime {
  constructor(private readonly deps: WorldEgoShardProjectileRuntimeDeps) {}
