...
import { TILE_WATER, TILE_MAGMA, TILE_OIL, TILE_ACID } from '../core/Physics';
...
const FLUID_MAPPING: Record<Temperament, FluidMapping> = {
  ...
  iron:   { slotA: TILE_WATER, slotB: TILE_WATER, slotC: TILE_WATER, containerPoolId: 'ItemWorld_Iron'   },
  rust:   { slotA: TILE_ACID,  slotB: TILE_OIL,   slotC: TILE_WATER, containerPoolId: 'ItemWorld_Rust'   },
  spark:  { slotA: TILE_WATER, slotB: TILE_ACID,  slotC: TILE_WATER, containerPoolId: 'ItemWorld_Spark'  },
  shadow: { slotA: TILE_OIL,   slotB: TILE_ACID,  slotC: TILE_WATER, containerPoolId: 'ItemWorld_Shadow' },
};
...
const TILE_TO_FLUID_TYPE_STR: Record<number, 'water' | 'magma' | 'oil' | 'acid'> = {
  [TILE_WATER]: 'water',
  [TILE_MAGMA]: 'magma',
  [TILE_OIL]:   'oil',
  [TILE_ACID]:  'acid',
