...
import { LegacyAnvilGateLaser } from '@effects/AnvilGateLaser';
...
export class LegacyLaserItemDeploymentController {
  ...
  private anvilLaser: LegacyAnvilGateLaser | null = null;
      ...
      case 'WallDeployment':
        {
          ...
          this.anvilLaser = new LegacyAnvilGateLaser(origin.x, origin.y, targetX);
