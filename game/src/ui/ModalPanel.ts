...
export const BUTTON_BG_ACCENT   = 0xffa41b;    // CTA orange (DEC-035 key color, brand #FFA41B 2026-05-20)
...
export const ROW_SELECTED_EDGE  = 0xffa41b;     // vibrant orange border (brand key color)
export const ROW_SELECTED_GLOW  = 0xffa41b;     // outer halo color (brand key color)
