...
| :-------- | :----------- | :-------- | :------------ | :----------------------------------- |
| Normal    | 흰색 #FFFFFF | x1.0      | 2             | 2 지층 (3×3 → 4×4)                  |
| Magic     | 파란 #6969FF | x1.3      | 3             | 3 지층 (3×3 → 4×4 → 4×4)           |
| Rare      | 노란 #FFFF00 | x1.7      | 4             | 3 지층 (3×3 → 4×4 → 5×5)           |
| Legendary | 주황 #FF8000 | x2.2      | 6             | 4 지층 (3×3 → 4×4 → 5×5 → 5×5)    |
| Ancient   | 초록 #00FF00 | x3.0      | 8             | 4 지층 + 심연 (3×3 → 4×4 → 5×5 → 5×5) |
