...
| G-09 | **System_Player_Abilities.md** | 벽 타기/안개 변신/수중 호흡/역중력 상세 물리 파라미터 (현재 대시/이단점프만 상세) | M2.2 | **DEPRECATED 2026-05-18 (안개 변신 폐기 — SotN 카피)**
...
| I-14 | 안개 변신 렐릭 | 1타일 높이 틈새 통과 | G-09 | **DEPRECATED 2026-05-18 (안개 변신 폐기 — SotN 카피)**
| I-15 | 수중 호흡 렐릭 | 산소 게이지 무제한 | G-09, UI 산소 게이지 |
| I-16 | 극성 부츠 렐릭 | 천장 경로 이동 | G-09 |
...
| A-09 | 렐릭 아이콘 6종 | 대시/이단점프/벽타기/수중/surge/diveAttack | M2.2 |
