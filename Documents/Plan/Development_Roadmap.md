...
| SYS-WLD-03 Ability Gating | 능력 게이트 (이단점프, 벽점프, 안개 변신) | **DEPRECATED 2026-05-18 (안개 변신 폐기 — SotN 카피)**
...
| M2.2 게이팅 시스템 | 능력 게이트 3종 (이단점프/벽점프/안개 변신) + 스탯 게이트 2종 (ATK 물리 장벽/INT 마법 봉인) | **DEPRECATED 2026-05-18 (안개 변신 폐기 — SotN 카피)**
