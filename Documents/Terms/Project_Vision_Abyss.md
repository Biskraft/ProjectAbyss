...
| 직업 | 독립 대장장이 겸 격벽 측량사 (중앙 성채 외곽) |
| 나이 | 19세 여성 |
| 에코 (도구) | 망치 "에코(Echo)" — **전투 무기가 아닌 대장장이 도구.** (1) 무기에 원소를 인챈트, (2) 모루/제단에서 아이템계에 진입하는 열쇠, (3) 격벽을 두드려 구조적 약점과 숨겨진 통로를 탐지. 기본 화(Fire), 보스 처치 시 원소 흡수 |
...
| 월드        | 월하의 야상곡의 고딕 성 — 연금술 연구소, 빙결 보존소, 카타콤, 천공의 정원 |
