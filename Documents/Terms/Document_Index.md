...
| RES-PWX-01 | Power Exchange & False-Faith Sacrifice | `Research/Research_PowerExchange_FalseFaith.md` | 지배-복종 3작품 분석 → 등재 의례·묵정·복종=해방 반전 (『アイル』↔등재 1:1) |
...
## 9. Narrative World (세력·사적 월드 GDD)

| ID | 문서명 | 경로 | 상태 |
| :--- | :--- | :--- | :--- |
| NAR-WLD-001 | 사적 등재단 월드 (Private Registration Commune) | `Narrative/Narrative_World_PrivateRegistration.md` | ✅ 활성 (2026-06-06, IDEA-01 승격) |
| NAR-FAC-003 | 봉인 의례 길드 (Seal Rite Guild) | `Narrative/Narrative_World_SealRiteGuild.md` | ✅ 활성 (2026-06-06, P0 이양) |
