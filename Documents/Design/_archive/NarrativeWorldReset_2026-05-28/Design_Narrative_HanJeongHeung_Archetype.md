...
> **작성일:** 2026-05-25
> **담당:** Victor (총괄·시나리오 적용), narrative-designer (검수)
...
| 항목 | 우선순위 | 처리 시점 |
|:--|:--|:--|
| **정보라 *Cursed Bunny* 리서치 보강** (K-Lit §7) — SF/호러로 한 형상화한 가장 직접적 ECHORIS-친화 사례 가능성 | Should | 첫 캐릭터 brief 작성 전 |
...
### 7.2. 첫 캐릭터 brief (CNT-CHR-001~005)

본 문서 §3.1 (두 화자 구조) + §3.2 (공간) + §3.4 (5막) 가 *첫 5명 Echo-Bearer 캐릭터 정의* brief 의 토대.
...
§3.1.2 + §3.4 의 5막-5조 매핑 → Rustborn dialogue 작성 시금석. narrative-designer 검수.
