...
| Greatsword (대검) | 길다 (~96px) | 느림 (x0.6) | 넓음 | 충격파 발사. 슈퍼아머 없음. 파워형 |
| Dagger (단검) | 짧다 (~40px) | 빠름 (x1.6) | 좁음 | 배후 강타 x3.0. 포지셔닝 의존 |
| Bow (활) | 원거리 (~240px) | 보통 (x1.0) | 점형 | 대시 직후 데미지 x1.2. 카이팅 특화 |
| Staff (지팡이) | 중거리 (~160px) | 느림 (x0.7) | 넓음 | 유일 INT 스케일링. 원소 증폭 x1.5 |
...
| Range | ~240px | 화면 너비(640px)의 37.5%. 실질 원거리 |
