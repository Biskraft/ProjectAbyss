...
- **말소자 4종은 일반 몹 풀과 분리된다.** 흰색 언캐니(near-white·단안 발광·비정상 비율)는 봉인 풀림(Ch.5)·전조(Ch.4)·안치소(Ch.6) 세트피스에만 출현하며, 귀여운 드론과 동석하지 않는다. 다수는 보스 F4(말소자 추격체, `SYS-ENM-BARC` §2.2.2)로 흡수되므로 몹 티어는 4종으로 충분하다.
...
|:---|:---:|:---|:---|
| **드론(환경 생물)** | ~22 | 귀여운 픽셀 정합·최빈 백본 | Charger/Jumper/Shooter/Swarmer/Flier 다수. 전 구역 + IW 전 테마 |
