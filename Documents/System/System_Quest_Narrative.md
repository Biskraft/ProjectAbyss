...
| [용의자] | 겉보기 유력 원인 | 강력한 야생 이노센트, 외부 침입 흔적, 아이템계 진입 부작용 |
...
| [위험 유형] | 위험의 종류 | 야생 이노센트 습격, 지층 붕괴, 기억 침식 함정, 외부 침입자 |
...
| 아이템계 진입 횟수 | 기억 탐구 고급 분기 개방, 심층 서사 해금 | 기본 기억 탐구 유지 |
...
| 고레어리티 아이템계 도전 여부 | 모험가(파티원 없이 심층 진입 위험) vs 장인(더 깊은 강화 욕구) |
...
| 고레어리티 순환 진입 | 더 높은 레어리티 아이템계 도전 / 안전한 현재 장비 강화 | 높은 난이도 ↔ 강력한 보상 | "끝없이 더 깊이" vs "안전한 귀환" |
...
| 아이템계 탈출/계속 결정 | 최소 (2갈래) | 리스크/리턴 긴장감 극대화 |
...
| 5 | 탐정 절차 | 기억의 지층 | 지층 이노센트 방랑자 | 이노센트 대량 소멸 원인 조사 | 단서 수집 결과, 다른 아이템의 기억이 이 아이템의 지층을 침식하고 있었다 | 아이템계 진입 경고 시스템 UI 갱신 |
