...
| TEL-07 | 세션 | game_loaded | P1 | 대기 | 로딩 시간 측정 |
| TEL-08 | 전투 | enemy_kill | P1 | 대기 | 적 처치 분포 |
| TEL-09 | 전투 | boss_fight | P1 | 대기 | 보스 난이도 검증 |
| TEL-10 | 진행 | item_drop | P1 | 대기 | 드랍 체감 분석 |
| TEL-11 | 진행 | item_equip | P1 | 대기 | 장비 교체 패턴 |
| TEL-12 | 진행 | item_level_up | P1 | 대기 | 아이템계 보상 체감 |
| TEL-13 | 진행 | gate_break | P1 | 대기 | 진행 페이싱 검증 |
| TEL-14 | 진행 | player_level_up | P2 | 대기 | 레벨 곡선 검증 |
| TEL-15 | 탐험 | room_enter | P2 | 대기 | 동선 히트맵 |
| TEL-16 | 탐험 | room_clear | P2 | 대기 | 방별 체류시간 |
| TEL-17 | 진행 | relic_acquire | P1 | 대기 | 능력 게이트 검증 |
| TEL-18 | UI | tutorial_step | P1 | 대기 | 튜토리얼 이탈 지점 |
| TEL-19 | UI | inventory_open | P2 | 대기 | 인벤토리 사용 빈도 |
| TEL-20 | 세션 | save_game | P2 | 대기 | 세이브 시점 = 이탈 시점 |
| TEL-21 | 전환 | demo_complete | P2-Phase | 대기 | 데모 완주율 |
| TEL-22 | 전환 | steam_wishlist_click | P2-Phase | 대기 | 위시리스트 전환율 |
...
| Phase | 이벤트 | 목적 |
| :--- | :--- | :--- |
| **P0 (현재)** | TEL-01 ~ TEL-06 | 스파이크 검증. "아이템계가 재미있는가?" |
| P1 (데모 폴리싱) | TEL-07 ~ TEL-13, TEL-17, TEL-18 | 밸런스 + 진행도 조정 |
| P2 (알파) | TEL-14 ~ TEL-16, TEL-19 ~ TEL-25 | 전환 퍼널 + 리텐션 |
