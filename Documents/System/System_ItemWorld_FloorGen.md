...
| 무기 카테고리 | 실제 방 수 | 방 비율 | 천장 높이 | 특수 구조 | 공간 성격 |
| :--- | :---: | :--- | :--- | :--- | :--- |
| 검 (Sword) | 16 (표준) | 1:1 정방 | 보통 | 없음 | 균형 잡힌 탐험 |
| 단검 (Dagger) | 20~24 (분할) | 1:2 좁고 긴 | 낮음 | 좁은 틈새, 막다른 길 | 미로 — 빠른 이동, 급습 |
| 대검 (Greatsword) | 6~8 (합체) | 2:1 넓음 | 높음 | 넓은 전장, 소수 강적 | 전장 — 느린 진행, 무거운 타격 |
| 도끼 (Axe) | 16 (표준) | 1:1 정방 | 보통 | 파괴 가능 벽/바닥 | 개척 — 길을 만드는 경험 |
| 창 (Spear) | 12~14 (수평 합체) | 1:3 횡장 | 보통 | 긴 수평 복도 | 돌진 — 사거리가 의미 있는 공간 |
| 지팡이 (Staff) | 16 (표준) | 불규칙 | 높음 | 부유 플랫폼, 수직 구조 | 마탑 — 위로 오르는 탐험 |
| 활 (Bow) | 8~10 (합체) | 2:1 넓음 | 매우 높음 | 고저차 지형, 엄폐물 | 사냥터 — 높은 곳을 잡는 전투 |
| 채찍 (Whip) | 14~16 | 1:1~1:2 혼합 | 높음 | 스윙 포인트, 갭 | 유동 — 매달리고 넘는 이동 |
