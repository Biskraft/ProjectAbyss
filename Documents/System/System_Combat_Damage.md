...
| DMG-03-A   | 원소       | 원소 상성 배율                       |    P1    | 📅 대기      | 4원소 상성표 (화/빙/뇌/암)     |
...
4가지 원소(화/빙/뇌 + 암)가 존재하며, 상성 관계에 따라 데미지 배율이 변동한다.
...
| 공격 \ 방어 | 화    | 빙    | 뇌    | 암    | 무    |
| :---------- | :---- | :---- | :---- | :---- | :---- |
| 화          | 0.5x  | 2.0x  | 1.0x  | 1.0x  | 1.0x  |
| 빙          | 0.5x  | 0.5x  | 2.0x  | 1.0x  | 1.0x  |
| 뇌          | 1.0x  | 0.5x  | 0.5x  | 2.0x  | 1.0x  |
| 암          | 1.0x  | 1.0x  | 0.5x  | 0.5x  | 1.0x  |
| 무          | 1.0x  | 1.0x  | 1.0x  | 1.0x  | 1.0x  |
...
**설계 의도**: DEF 100일 때 피해 50 감소. ATK 200 - 피해 감소 50 = 150 피해. 방어력의 효과가 직관적���로 예측 가능하다.
...
> **설계 변경:** ATK/INT/HP 3스탯 체계. 물리는 ATK 기반, 원소는 INT 기반. 회피(MISS) 삭제 (모든 공격 적중, 대시 i-frame으로 대체). 원소 적중률 100% (상태이상 항상 발동, 지속시간은 INT 스케일).
...
> **⚠️ DEPRECATED:** 회피/명중 시스템은 삭제되었습니다. 모든 공격은 적중합니다. 회피는 대시 i-frame으로 대체됩니다. DEX 스탯은 삭제되었습니다.
...
damage_formula:
  ...
  res_factor: 0.5                      # RES 1당 원소 피해 감소
  ...
  # 회피/명중 시스템 삭제. 모든 공격은 적중. 회피는 대시 i-frame으로 대체.
...
* [ ] 회피 시스템은 DEPRECATED (대시 i-frame으로 대체)되어 작동하지 않는가
* [ ] 범위 공격에 회피가 적용되지 않는가
