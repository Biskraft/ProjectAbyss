...
| 무기 카테고리 | 1타              | 2타              | 3타                  | 특성                  |
| :------------ | :--------------- | :--------------- | :------------------- | :-------------------- |
| 검 (Sword)    | 수평 베기        | 대각 베기        | 수평 대회전          | 표준형, 밸런스 (ATK 100%) |
| 대검 (Greatsword)| 대사선 베기   | 수평 대소용돌이  | — (2타 종료)         | 느림, 충격파, 넓은 범위 (ATK 120%) |
| 단검 (Dagger) | 찌르기          | 역수 베기        | 상향 슬래시 → 4타 돌진 | 최고 속도, 배후 강타 (ATK 80%) |
| 활 (Bow)      | 속사            | 속사             | 충전 화살            | 원거리 물리, 카이팅 (ATK 90%) |
| 지팡이 (Staff)| 마법탄          | 마법탄           | 강화 마법탄          | 원거리 원소, 인챈트 증폭 (INT 100%) |
