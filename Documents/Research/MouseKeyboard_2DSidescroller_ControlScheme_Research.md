...
- 장비 비교, 기억 단편 관리처럼 "두 아이템을 비교 선택"하는 판단이 필요할 때
...
| **인벤토리/장비 관리** | **높음** | 아이템 비교, 기억 단편 관리, 장비 교체 등 복잡한 UI 조작. Mouse가 압도적 효율 |
...
| 인벤토리/장비 관리 | **Mouse 지원 추가** | 기억 단편 관리, 장비 비교, 슬롯 배치에 Mouse가 압도적 효율 |
...
| 우선순위 | 기능 | 근거 |
| :--- | :--- | :--- |
| P1 | 인벤토리 Mouse 클릭/드래그 지원 | 야리코미의 핵심=장비 관리. 기억 단편 40개 이상을 KB 방향키로 탐색하는 것은 고통 |
...
- **UI/인벤토리:** Mouse 클릭/드래그 지원 추가. 야리코미(기억 단편 관리, 장비 비교)의 쾌적성에 직결
