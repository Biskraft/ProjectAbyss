...
> **적용 대상:** Project Abyss 아이템계 (기억의 지층) 보상/난이도 커브 설계
...
9. [Project Abyss 적용 제안](#9-project-abyss-적용-제안)
...
- 어둠 = 자연스러운 깊이 제한자. Project Abyss의 "기억의 침식" 유사 개념 가능
...
### 4.4 Project Abyss 기억의 지층에 적합한 긴장 곡선
...
| **Project Abyss** | 탈출 제단 (25%) + 보스 후 | 탈출 제단은 무료 | 25% 확률 스폰 | 제단 발견 불확실성 + 보스까지 생존 |
...
### 5.3 Project Abyss 탈출 제단의 긴장 설계
