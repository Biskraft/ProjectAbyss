...
|:-----|:-----|:--------|:--------|:---------|
| 1층 | 3×3 | `corridor`, `safe` | `foreshadow` | 도입. 단순 수평 진행, 학습, 다음 지층 전조 |
| 2층 | 4×4 | `branch`, `shaft` | `secret` | 확장. 분기 탐색 시작, 수직 요소, 숨겨진 보상 |
| 3층 | 5×5 | `parallel`, `funnel`, `arena` | `open` | 심화. 병렬 선택, 퍼널 긴장, 보스 전투 정점 |
| 4층 (심연) | 5×5 | `spiral`, `network`, `oneway` | — | 극한. 나선 압박, 복잡도 극대화, 리스크 |
