...
### 4.5 sci-fi 산업 + 고독 톤 선례

Axiom Verge(9 구역 sci-fi 산업 + 글리치 비밀 구역), Ghost Song(황량한 달 + 코스믹 테러) 이 ECHORIS 의 산업 메가 스트럭처 + 고독 톤의 장르 선례. 특히 Axiom Verge 의 "글리치/오염 비밀 구역" = ECHORIS 봉인된 하부·말소자 침식 구역의 참고.
