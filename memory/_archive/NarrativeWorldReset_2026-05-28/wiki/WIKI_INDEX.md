...
- [FluidVfxPerformance](features/FluidVfxPerformance.md) - Steam/splash particle caps and passive fluid reaction VFX budget rules.
- [ItemWorldEntryStreaming](features/ItemWorldEntryStreaming.md) - Shaft/anvil Item World entry prestreams ItemStratum templates, bundles, and tilesets before scene push.
...
- [ParallaxBackground](features/ParallaxBackground.md) - Screen-space Sprite-grid parallax renderer; avoid Pixi `TilingSprite` repeat sampler in shipping builds.
- [WeatherSystem](features/WeatherSystem.md) - LDtk `Weather` entity authoring and runtime rain/snow rendering rules.
...
- [2026-05-28](daily/2026-05-28.md) - Added dynamic Builder weather collision so rain and splash sprites hit moving Builder surfaces at their current pixel position.
- [2026-05-28](daily/2026-05-28.md) - Switched rain impact splashes to one pooled random sprite per hit with a 48-instance cap.
- [2026-05-28](daily/2026-05-28.md) - Fixed long rain streak collision so drawn rain tips despawn on solid/one-way tile contact instead of visually penetrating floors.
- [2026-05-28](daily/2026-05-28.md) - Wired LDtk `Weather` entities into `LdtkWorldScene` using `WeatherSystem` with Rain/Snow density, wind, and streak controls.
- [2026-05-28](daily/2026-05-28.md) - Reduced acid-water steam particle load with SteamPuff/WaterSplash hard caps and passive fluid reaction VFX budgets.
- [2026-05-28](daily/2026-05-28.md) - Applied grayscale/contrast 0.5 to `ItemStratum_Corridor` and its live parallax background, and added a camera zoom lock so the anvil laser keeps zoom at 1.0 except debug zoom keys.
- [2026-05-27](daily/2026-05-27.md) - Switched `ItemStratum_Corridor` entry to the real LDtk level with black platform reveal over live parallax, excluded cinematic templates from random Item World rooms, and added a 1000ms max-width anvil laser hold.
...
- [2026-05-27](daily/2026-05-27.md) - Fixed armed Item World deployment so reaching the overworld right edge enters the corridor-left start instead of doing nothing.
- [2026-05-27](daily/2026-05-27.md) - Added the `ItemStratum_Corridor` interstitial for overworld Item World entries, including x-coordinate handoff into the start room ceiling.
- [2026-05-27](daily/2026-05-27.md) - Made the anvil deployment ItemStratum ghost room walkable by temporarily extending Shaft collision/camera bounds and moving the entrance trigger inside it.
- [2026-05-27](daily/2026-05-27.md) - Added Item World entry prestreaming from Shaft/anvil flow: cached ItemStratum templates plus bundle/theme/extra tileset warmup before scene push.
- [2026-05-27](daily/2026-05-27.md) - Replaced parallax `TilingSprite` repeat sampling with a screen-space Sprite grid to avoid shipping square artifacts.
