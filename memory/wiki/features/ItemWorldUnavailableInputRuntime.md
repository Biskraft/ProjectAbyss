...
- It consumes those actions and shows `toast.currently_unavailable`, preserving the previous Item World policy that map/inventory are recognized but disabled.
