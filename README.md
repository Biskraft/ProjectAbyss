...
> 메트로베니아 탐험 + 디스가이아식 아이템계 야리코미 + 스펠렁키식 절차적 생성

### 2-Space 분리 모델

| 공간 | 목적 | 인원 | 맵 유형 |
|------|------|------|---------|
| **월드 (World)** | 탐험, 능력 획득, 대장간/상점 (세이브 포인트) | 솔로 | 핸드크래프트 + 절차적 혼합 |
| **아이템계 (Item World)** | 아이템 강화, 야리코미 | 1~4인 | 완전 절차적 생성 (지층 던전) |

> 📦 narrative 컨셉 archived 2026-05-28 → `Documents/Terms/_archive/NarrativeWorldReset_2026-05-28/`
